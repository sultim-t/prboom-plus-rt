...
//-----------------------------------------------------------------------------
//
// $Id: M_menu.h,v 1.1 2000/04/09 18:21:17 proff_fs Exp $
//
...
void M_DrawBackgr(char *patch, byte *screen);  // killough 11/98
#ifdef GL_DOOM
// proff 11/99: use OpenGL
#define M_DrawBackground(n,s) gld_DrawBackground(n)
#else
#define M_DrawBackground(n,s) M_DrawBackgr(n,s)
#endif
...
//
// $Log: M_menu.h,v $
// Revision 1.1  2000/04/09 18:21:17  proff_fs
// Initial revision
//
