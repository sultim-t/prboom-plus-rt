...
//-----------------------------------------------------------------------------
//
// $Id: P_inter.c,v 1.1 2000/04/09 18:20:25 proff_fs Exp $
//
...
static const char
rcsid[] = "$Id: P_inter.c,v 1.1 2000/04/09 18:20:25 proff_fs Exp $";
...
H_boolean P_GiveAmmo(player_t *player, ammotype_t ammo, int num)
{
  int oldammo;
...
H_boolean P_GiveWeapon(player_t *player, weapontype_t weapon, H_boolean dropped)
{
  H_boolean gaveammo;
...
H_boolean P_GiveBody(player_t *player, int num)
{
...
H_boolean P_GiveArmor(player_t *player, int armortype)
{
...
H_boolean P_GivePower(player_t *player, int power)
{
...
{
  player_t *player;
  H_boolean justhit;          // killough 11/98
...
//
// $Log: P_inter.c,v $
// Revision 1.1  2000/04/09 18:20:25  proff_fs
// Initial revision
//
