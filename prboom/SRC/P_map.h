...
//-----------------------------------------------------------------------------
//
// $Id: P_map.h,v 1.1 2000/04/09 18:00:03 proff_fs Exp $
//
...
H_boolean P_CheckSight(mobj_t *t1, mobj_t *t2);
...
H_boolean Check_Sides(mobj_t *, int, int);                    // phares
...
extern H_boolean floatok;
extern H_boolean felldown;   // killough 11/98: indicates object pushed off ledge
...
//
// $Log: P_map.h,v $
// Revision 1.1  2000/04/09 18:00:03  proff_fs
// Initial revision
//
