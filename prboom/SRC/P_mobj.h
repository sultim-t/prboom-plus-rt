...
//-----------------------------------------------------------------------------
//
// $Id: P_mobj.h,v 1.1 2000/04/09 18:19:58 proff_fs Exp $
//
...
#define MF_SPECIAL      (longlong)(0x0000000000000001)
// Blocks.
#define MF_SOLID        (longlong)(0x0000000000000002)
// Can be hit.
#define MF_SHOOTABLE    (longlong)(0x0000000000000004)
// Don't use the sector links (invisible but touchable).
#define MF_NOSECTOR     (longlong)(0x0000000000000008)
// Don't use the blocklinks (inert but displayable)
#define MF_NOBLOCKMAP   (longlong)(0x0000000000000010)

// Not to be activated by sound, deaf monster.
#define MF_AMBUSH       (longlong)(0x0000000000000020)
// Will try to attack right back.
#define MF_JUSTHIT      (longlong)(0x0000000000000040)
// Will take at least one step before attacking.
#define MF_JUSTATTACKED (longlong)(0x0000000000000080)
// On level spawning (initial position),
//  hang from ceiling instead of stand on floor.
#define MF_SPAWNCEILING (longlong)(0x0000000000000100)
// Don't apply gravity (every tic),
//  that is, object will float, keeping current height
//  or changing it actively.
#define MF_NOGRAVITY    (longlong)(0x0000000000000200)

// Movement flags.
// This allows jumps from high places.
#define MF_DROPOFF      (longlong)(0x0000000000000400)
// For players, will pick up items.
#define MF_PICKUP       (longlong)(0x0000000000000800)
// Player cheat. ???
#define MF_NOCLIP       (longlong)(0x0000000000001000)
// Player: keep info about sliding along walls.
#define MF_SLIDE        (longlong)(0x0000000000002000)
// Allow moves to any height, no gravity.
// For active floaters, e.g. cacodemons, pain elementals.
#define MF_FLOAT        (longlong)(0x0000000000004000)
// Don't cross lines
//   ??? or look at heights on teleport.
#define MF_TELEPORT     (longlong)(0x0000000000008000)
// Don't hit same species, explode on block.
// Player missiles as well as fireballs of various kinds.
#define MF_MISSILE      (longlong)(0x0000000000010000)
// Dropped by a demon, not level spawned.
// E.g. ammo clips dropped by dying former humans.
#define MF_DROPPED      (longlong)(0x0000000000020000)
// Use fuzzy draw (shadow demons or spectres),
//  temporary player invisibility powerup.
#define MF_SHADOW       (longlong)(0x0000000000040000)
// Flag: don't bleed when shot (use puff),
//  barrels and shootable furniture shall not bleed.
#define MF_NOBLOOD      (longlong)(0x0000000000080000)
// Don't stop moving halfway off a step,
//  that is, have dead bodies slide down all the way.
#define MF_CORPSE       (longlong)(0x0000000000100000)
// Floating to a height for a move, ???
//  don't auto float to target's height.
#define MF_INFLOAT      (longlong)(0x0000000000200000)

// On kill, count this enemy object
//  towards intermission kill total.
// Happy gathering.
#define MF_COUNTKILL    (longlong)(0x0000000000400000)
    
// On picking up, count this item object
//  towards intermission item total.
#define MF_COUNTITEM    (longlong)(0x0000000000800000)

// Special handling: skull in flight.
// Neither a cacodemon nor a missile.
#define MF_SKULLFLY     (longlong)(0x0000000001000000)

// Don't spawn this object
//  in death match mode (e.g. key cards).
#define MF_NOTDMATCH    (longlong)(0x0000000002000000)

// Player sprites in multiplayer modes are modified
//  using an internal color lookup table for re-indexing.
// If 0x4 0x8 or 0xc,
//  use a translation table for player colormaps
#define MF_TRANSLATION  (longlong)(0x000000000c000000)
#define MF_TRANSLATION1 (longlong)(0x0000000004000000)
#define MF_TRANSLATION2 (longlong)(0x0000000008000000)
// Hmm ???.
...
#define MF_STEALTH      (longlong)(0x0000000010000000)
...
#define MF_TRANSLUCBITS (longlong)(0x0000000060000000)
#define MF_TRANSLUC25   (longlong)(0x0000000020000000)
#define MF_TRANSLUC50   (longlong)(0x0000000040000000)
#define MF_TRANSLUC75   (longlong)(0x0000000060000000)

    // Translucent sprite?                                          // phares
#define MF_TRANSLUCENT  (longlong)(0x0000000040000000)

// these are greater than an int. That's why the flags below are now longlong
...
H_boolean P_SetMobjState(mobj_t *mobj, statenum_t state);
...
//
// $Log: P_mobj.h,v $
// Revision 1.1  2000/04/09 18:19:58  proff_fs
// Initial revision
//
