...
//-----------------------------------------------------------------------------
//
// $Id: P_spec.h,v 1.1 2000/04/09 18:19:14 proff_fs Exp $
//
...
result_e T_MovePlane(sector_t* sector, fixed_t speed, fixed_t dest,
                     H_boolean crush, int floorOrCeiling, int direction);
...
int EV_SilentLineTeleport(line_t* line, int side,
                          mobj_t* thing, H_boolean reverse);
...
// when needed
H_boolean P_UseSpecialLine(mobj_t* thing, line_t* line, int side);
...
//
// $Log: P_spec.h,v $
// Revision 1.1  2000/04/09 18:19:14  proff_fs
// Initial revision
//
