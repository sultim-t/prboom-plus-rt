...
void G_LoadGame(int slot, DOOM_BOOL is_command); // killough 5/15/98
...
void G_SaveGameName(char *, size_t, int, DOOM_BOOL); /* killough 3/22/98: sets savegame filename */
...
extern DOOM_BOOL haswolflevels;  //jff 4/18/98 wolf levels present
