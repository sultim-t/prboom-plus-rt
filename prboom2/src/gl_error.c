...
**
** $Date: 2002/11/16 11:01:56 $ $Revision: 1.1 $
** $Header: /home/droffel/prboom/prboom/prboom2/src/Attic/gl_error.c,v 1.1 2002/11/16 11:01:56 proff_fs Exp $
*/
...
const char *__gluTessErrorString( GLenum errorCode )
{
    return __gluTessErrors[errno];
} /* __glTessErrorString() */

const GLubyte* GLAPI
p_gluErrorString(GLenum errorCode)
{
    if (errorCode == 0) {
