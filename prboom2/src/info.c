...
#if RT_DOOM1_HACKS // disable extralight on plasmagun
  {SPR_PLSF,32768,4,A_Light1_NoRT,S_LIGHTDONE,0,0},  // S_PLASMAFLASH1
  {SPR_PLSF,32769,4,A_Light1_NoRT,S_LIGHTDONE,0,0},  // S_PLASMAFLASH2
#else 
