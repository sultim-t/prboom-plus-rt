...
#define GETCOL16_ROUNDED(texV, nextRowTexV) VID_SHORTPAL(GETCOL8_DEPTH(filter_getRoundedForColumn(texV,nextRowTexV)), VID_COLORWEIGHTMASK)
...
#define GETCOL32_ROUNDED(texV, nextRowTexV) VID_INTPAL(GETCOL8_DEPTH(filter_getRoundedForColumn(texV,nextRowTexV)), VID_COLORWEIGHTMASK)
