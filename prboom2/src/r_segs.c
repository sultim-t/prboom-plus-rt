...
static DOOM_BOOL  segtextured;
static DOOM_BOOL  markfloor;      // False if the back side is the same plane.
static DOOM_BOOL  markceiling;
static DOOM_BOOL  maskedtexture;
