...
DOOM_BOOL WI_Responder(event_t* ev)
{
  return false;
}
...
static DOOM_BOOL    snl_pointeron = false;
...
{
  //e6y
  static DOOM_BOOL play_early_explosion = true;
